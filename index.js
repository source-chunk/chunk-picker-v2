...
const myWorker = new Worker("./worker.js?v=4.12.15");
...
var unlockChallenges = function() {
    if (workerOut === 0) {
        $('.panel-active span.burger').removeClass('hidden-burger');
        $('.panel-active label.checkbox').removeClass('checkbox--disabled');
        $('.panel-active label.checkbox input').attr('disabled', false);
    }
}
